# 3D version
This document provides instructions to run the Matlab and Python implementation of DDHADtens 3D, which computes internal damage variables from collections of 6x6 matrices.
# Matlab version
